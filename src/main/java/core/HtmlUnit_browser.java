...
//	     driver.manage().window().maximize();
		 ...
		 String user_password = decrypt(encrypted_password, new
		 SecretKeySpec(Arrays.copyOf(mac_address.getBytes("UTF-8"), 16), "AES"));
		 ...
		 By timeline = By.xpath(".//*[@class='_1qv9']//span");
...
//		 By logout = By.xpath("//span[text()='Log Out']");
		 ...
		 String copyright =
		 wait.until(ExpectedConditions.presenceOfElementLocated(Copyright)).getText();
		 ...
		 System.out.println("01. Browser: HtmlUnit");
		 System.out.println("02. Title of the page: " + title);
		 System.out.println("03. Copyright: " + copyright);
		 System.out.println("04. Element [Copyright Text]: " + (isPresent(Copyright) ?
		 "Exists" : " Not exist "));
		 System.out.println("05. Size of [Copyright Text]: " + copyright_Size);
		 System.out.println("06. Location of [Copyright Text]: " +
		 copyright_Location);
		 ...
		 System.out.println("07. Element [Email Field]: " + (isPresent(email) ?
		 "Exists" : " Not exist "));
		 System.out.println("08. Size of [Email Field]: " + email_Size);
		 System.out.println("09. Location of [Email Field]: " + email_Location);
		 System.out.println("10. Element [Password Field]: " + (isPresent(password) ?
		 "Exists" : " Not exist "));
		 ...
		 System.out.println("13. Element [Log In Button]: " + (isPresent(login) ?
		 "Exists" : " Not exist "));
		 ...
		 System.out.println("16. Element [Timeline Button]: " + (isPresent(timeline) ?
		 "Exists" : " Not exist "));
		 System.out.println("17. Size of [Timeline Button]: " + timeline_Size);
		 System.out.println("18. Location of [Timeline Button]: " +
		 timeline_Location);
...
//		 System.out.println(driver.getPageSource());
		 ...
		 System.out
		 .println("23. Element [Account Settings Button]: " + (isPresent(timeline) ?
		 "Exists" : " Not exist "));
...
//		super(new BrowserVersionBuilder(BrowserVersion.INTERNET_EXPLORER).setUserAgent("Mozilla/5.0 (Macintosh; Intel Mac OS X 10.13; rv:55.0) Gecko/20100101 Firefox/55.0").build(), true);
		super(BrowserVersion.INTERNET_EXPLORER, true);
